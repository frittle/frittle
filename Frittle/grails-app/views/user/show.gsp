	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.dashboards}">
				<li class="fieldcontain">
					<span id="dashboards-label" class="property-label"><g:message code="user.dashboards.label" default="Dashboards" /></span>
					
						<g:each in="${userInstance.dashboards}" var="d">
						<span class="property-value" aria-labelledby="dashboards-label"><g:link controller="dashboard" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></span>
						</g:each>
